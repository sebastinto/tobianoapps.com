...
import com.tobianoapps.website.components.sections.project.ProjectLayout
import com.tobianoapps.website.components.sections.project.ProjectLayoutContent
...
fun LandingPageLayout() {
    ...
    Box(
        ...
        Column(
            ...
            Header(
                colorMode = colorMode, onThemSwitchClicked = {
            ...
            Column(
                ...
                Project.all.forEach {
                    ProjectLayout(breakpoint = breakpoint) {
                        ProjectLayoutContent(project = it, breakpoint = breakpoint)
                    }
                }
            }
